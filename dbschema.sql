...
CREATE TABLE "tasks" (
  ...
  "description" text,
  "assigned_to" integer,
  "status" enum(backlog,started,ongoing,testing,completed,done),
...
CREATE TABLE "task_logs" (
  "id" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY NOT NULL,
  "task_id" integer NOT NULL,
  "change_type" enum(status,assigner,assignee,comment),
  "old_value" text,
  "new_value" text,
  "created_by" integer NOT NULL,
  "created_at" timestamp DEFAULT (now())
...
CREATE TABLE "notification" (
  ...
  "type" enum(assignment,mention,comment,status_change),
  "link_to" text,
...
ALTER TABLE "user_email_token" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("id");
