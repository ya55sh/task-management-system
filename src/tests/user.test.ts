...
// let token =
// 	"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjoxOCwiZW1haWwiOiJ0ZXN0dXNlckBleGFtcGxlLmNvbSIsImZpcnN0TmFtZSI6Inlhc2giLCJsYXN0TmFtZSI6ImJhaHVndW5hIiwiaWF0IjoxNzUzMTU5MTY2LCJleHAiOjE3NTMxNjI3NjZ9.szqnkO0x7VHHh0oebFYmpgclHQOo2Fpekqgq5sGOgNI";
...
// 			role: "1",
// 		};
// 		const res = await request(app).put("/v1/user/18").set("Authorization", `Bearer ${token}`).send(userPayload);
// 		console.log(res.body);
// 		expect(res.status).toBe(200);
// 		expect(res.body).toHaveProperty("message");
